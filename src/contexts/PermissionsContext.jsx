...
const defaultPermissions = {
    admin: {
        ...
        manufactured_products: ['create', 'read', 'update', 'delete'],
        ...
        quality_checks: ['create', 'read', 'update', 'delete'],
        manufacturing_inventory: ['create', 'read', 'update', 'delete'],
        // Logistics
    ...
    sales_operator: {
        ...
        // Manufacturing
        production: ['read'],
        manufactured_products: ['read'],
        work_orders: ['read', 'update'],
        raw_materials: ['read'],
        suppliers: ['read'],
        material_movements: ['read'],
        quality_checks: ['read'],
        manufacturing_inventory: ['read'],
    },
    user: {
        dashboard: ['read'],
        employees: [],
