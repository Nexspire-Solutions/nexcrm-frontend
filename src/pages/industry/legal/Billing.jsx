...
export default function Billing() {
    ...
    const fetchInvoices = async () => {
        try {
            const response = await apiClient.get('/legal-billing/invoices');
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                ...
                <Link to="/legal-invoices/new" className="px-4 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors flex items-center gap-2">
