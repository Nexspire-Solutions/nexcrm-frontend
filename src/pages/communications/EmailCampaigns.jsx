...
export default function EmailCampaigns() {
    ...
    const [isLaunching, setIsLaunching] = useState(null); // ID of campaign being launched
    ...
    const handleSendCampaign = async (id) => {
        ...
        try {
            ...
            const errorMsg = error.response?.data?.error || error.message || 'Failed to send campaign';
            if (errorMsg.includes('SMTP') || errorMsg.includes('setup required')) {
                setShowSmtpModal(true);
            } else {
                                            ...
                                            <div className="flex items-center gap-1" onClick={(e) => e.stopPropagation()}>
                                                {campaign.status === 'draft' && (
                                                    ...
                                                    >
                                                        ...
                                                        {isLaunching === campaign.id ? 'Launching...' : 'Send'}
                                                    </button>
                                                )}
                                                <button
